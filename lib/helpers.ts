 ...
 * @example interpolate("This is an example of a [link](https://hansard.parlimen.gov.my)")
 * // ["This is an example of a", <a href="https://hansard.parlimen.gov.my">link</a>]
  ...
  return matches.map(item => {
    ...
    return createElement(
      "a",
      {
        href: url,
        className:
          "text-primary dark:text-secondary hover:underline inline [text-underline-position:from-font]",
        target: "_blank",
      },
      text
    );
