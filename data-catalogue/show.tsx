            ...
            <div className="space-y-6">
                        ...
                        <li key={item.title}>
                          <span className="flex gap-x-1">
                            {Boolean(item.unique_id) ? (
                              <At href={`/katalog/${item.unique_id}`}>
                                {item.title}
                              </At>
                            ) : (
                              item.title
                    ...
                    ([key, url]: [string, unknown]) =>
                      url ? (
                        <li key={url as string}>
                          <a
                            href={url as string}
                            className="break-all text-primary [text-underline-position:from-font] hover:underline dark:text-secondary"
                            onClick={() =>
                              track(
                                key === "link_geojson"
                                  ? "csv"
              ...
              <div className="space-y-3">
                ...
                <p className="text-dim">
                  {t("license_text")}{" "}
                  <a
                    className="lowercase text-primary [text-underline-position:from-font] hover:underline dark:text-secondary"
                    target="_blank"
                    rel="noopener"
