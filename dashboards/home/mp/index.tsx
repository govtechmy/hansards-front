...
import MPFilter, { MPFilterProps } from "./mp-filter";
...
export interface MPProps extends Omit<MPFilterProps, "onLoad"> {
  timeseries: Record<"date" | "freq", number[]>;
}

const MP = ({ individu_list, query, timeseries }: MPProps) => {
  ...
  return (
    <>
      <Section>
        {/*  */}
        <h2 className="header text-center">{t("search")}</h2>
